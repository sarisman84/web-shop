...
const inStockList = data.products.filter(
  (product) => product.availabilityStatus == "In Stock",
);
const lowStockList = data.products.filter(
  (product) => product.availabilityStatus == "Low Stock",
);
const emptyStockList = data.products.filter(
      ...
      >
        ...
        >
          <path
            fill="currentColor"
            fillRule="evenodd"
            d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92ZM11 13a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm-1-8a1 1 0 0 0-1 1v3a1 1 0 0 0 2 0V6a1 1 0 0 0-1-1Z"
            clipRule="evenodd"
          />
        </svg>
      </Card>
