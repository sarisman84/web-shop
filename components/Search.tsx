    ...
    return(
        <div className="w-full rounded-lg border border-gray-300 bg-white p-4">
            <div className="flex items-center gap-3">
                <input type="text" placeholder="Search products..." className="h-8 flex-1 rounded border border-gray-300 px-3 text-xs text-gray-900 placeholder:text-gray-400 outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-200"/>
               
                <select className="h-8 w-32 rounded border border-gray-300 bg-white px-2 text-xs text-gray-900 outline-none">
                ...
                <button className="flex h-8 items-center gap-1.5 rounded border border-gray-300 bg-white px-3 text-xs font-medium text-gray-900 hover:bg-gray-50">
